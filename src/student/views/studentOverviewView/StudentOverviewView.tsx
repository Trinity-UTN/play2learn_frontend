...
// import type { Achievement } from "../../types/walletType";
...
const StudentOverviewView: React.FC = () => {
  ...
  //     description: "Estudiaste 5 días seguidos",
  //     icon: "📚",
  //     color: "#2196F3",
  //     isUnlocked: false,
  //     progress: 3,
  ...
  //     id: "3",
  //     name: "Explorador",
  //     description: "Visitaste todas las secciones del curso",
  //     icon: "🗺️",
  //     color: "#FF9800",
  //     isUnlocked: false,
  //   },
  ...
  return (
    ...
    //         {/* ¡Hola, {student?.name?.split(" ")[0]}! 👋 EN PROXIMA IMPLEMENTACIONES... */}
    //         ¡Hola, Pedrito! 👋
    //       </h1>
