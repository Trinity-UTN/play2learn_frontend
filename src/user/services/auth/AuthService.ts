...
class AuthService {
    ...
    private static BASE_URL = "https://play2learn.backend.desarrollo.systemsbinary.com";
    private static onSessionExpiredCallback: (() => void) | null = null;

    //Funcion que reaciona ante el cambio de isAuthenticated
    static setOnSessionExpiredCallback(cb: () => void) {
